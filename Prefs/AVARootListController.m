...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/Avrora.disabled"]) return;
    [[self enableSwitch] setEnabled:NO];

    UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Avrora"
	message:@"Avrora Preferences disabled due to Avrora being disabled with iCleaner Pro"
...
- (void)resetPreferences {
    ...
    [[NSFileManager defaultManager] removeItemAtPath:@"/var/mobile/Library/Preferences/love.litten.avrora.datepreferences.plist" error:nil];
    [[NSFileManager defaultManager] removeItemAtPath:@"/var/mobile/Library/Preferences/love.litten.avrora.clockpreferences.plist" error:nil];
    [[NSFileManager defaultManager] removeItemAtPath:@"/var/mobile/Library/Preferences/love.litten.avrora.weatherpreferences.plist" error:nil];
    [[NSFileManager defaultManager] removeItemAtPath:@"/var/mobile/Library/Preferences/love.litten.avrora.nowplayingpreferences.plist" error:nil];
